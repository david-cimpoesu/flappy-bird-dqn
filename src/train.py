...
MAX_EPISODES = 50000  # Total games to play
MAX_STEPS = 2000  # Max steps per game (to prevent infinite loops)
BATCH_SIZE = 258
BUFFER_SIZE = 100000  # Course suggests 50k, but 30k is fine for 16GB RAM
LEARNING_RATE = 1e-4
GAMMA = 0.99
EPSILON_START = 1.0
EPSILON_END = 0.02
EPSILON_DECAY = 300000  # Frames over which epsilon decays
...
def main():
    ...
    for episode in range(1, MAX_EPISODES + 1):
        ...
        print(f"Episode {episode} | Reward: {episode_reward:.2f} | Epsilon: {epsilon:.4f} | Loss: {loss_val:.4f} | Pipes: {pipes_passed} | Jumps: {jumps} | No Jumps: {no_jumps}")
